...
<form id="exSolicitud" name="exSolicitud" method="post" action="<c:out value='${url}'/>exPoliza"   runat="server" >
...
<form  id="frmLogin" name="frmLogin" method="post" action="<c:out value='${url}'/>polizaG" runat="server"   >
	<input name="method" value="" type="hidden">
	<input type="hidden" name="id" >
			...
			<td valign="middle" align="center" style="height: 100%;"  height="100%" >
					<table class="rxbn" cellpadding="4" cellspacing="1" 	style="width:900px" align="center">
						<tr>
							...
							&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;
						&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;	&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
						&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;P&oacute;liza de Seguro - Tarjeta de Cr&eacute;dito
							</th>
...
<tr><td style="height: 20px" ></td></tr>
	<tr>
		<td  align="center"><strong> Abrir P&oacute;liza de Seguro  </strong></td>
	</tr>
</table>
</center>
<center>
