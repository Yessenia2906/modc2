...
<body class="" style="background-color: #F0F0F0;">
	...
	<form id="frmLogin" name="frmLogin" method="post"
		action="<c:out value='${url}'/>filterlog" runat="server">
														...
														<table align="center" width="85%" border="0">
															...
															<tr>
																<td><display:table id="dataTable"
																		...
																		<display:column property="hora" title="HORA"></display:column>
																		...
																		<display:column property="codAgencia" title="Cod.">
																		</display:column>
																		<display:column property="nombreAgencia" title="Nombre Agencia">
																		</display:column>
																	</display:table></td>
