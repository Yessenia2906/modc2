...
function validar(){
	 ...
	 if (document.frmLogin.numero.value.length < 8) {
...
<form id="exCancelacion" name="exCancelacion" method="post" action="<c:out value='${url}'/>exCancelacion"   runat="server" >
	<input	id="numero" name="numero" value = "<c:out value="${cancelacion.NUMDOC}"  />" type="hidden" /> 
	<input	id="pol1" name="pol1" type="hidden" /> 
	<input	id="sol1" name="sol1" type="hidden" /> 
</form>


<form  id="frmLogin" name="frmLogin" method="post" action="<c:out value='${url}'/>cancelacionG" runat="server"   >
		...
		<tr>
			<td valign="middle" align="center" style="height: 100%;"  height="100%" >
					<table class="rxbn" cellpadding="4" cellspacing="1" 	style="width:900px" align="center">
						...
						&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;	&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
						&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; Emisi&oacute;n de la Cancelaci&oacute;n - Tarjeta de Cr&eacute;dito
							</th>
										...
										<td align="left">
											...
											<table width="100%">
												...
												<tr>
													...
													<td width="24%" align="center">N&ordm; de Dni:&nbsp;&nbsp; &nbsp;&nbsp; 
													<input type="text" id="numero" name="numero" value=""  onKeyPress="return checkIt(event)" style="width: 90px;"  maxlength="8"   /></td>
...
<tr><td style="height: 20px" ></td></tr>
	<tr>
		<td  align="center"><strong> Abrir la Cancelaci&oacute;n Tarjeta de Cr&eacute;dito </strong></td>
	</tr>
</table>
</center>
<center>
<table width="60%" align="center" bgcolor="white">
	<tr>
		...
		<input type="button" onclick="exportar(<c:out value="${cancelacion.NUMDOC}"  />)"    class= "small"	value="Abrir">
