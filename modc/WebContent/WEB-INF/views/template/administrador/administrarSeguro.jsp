...
<title>ADMINISTRAR POLIZA</title>
...
<form  id="frmLogin" name="frmLogin" method="post" action="<c:out value='${url}'/>administrarSeguro1" runat="server"   >
										...
										<td align="left">
											...
											<table width="100%">
												...
												<tr>
													...
													<td width="24%" align="center">Actualizar Formato:&nbsp;&nbsp; &nbsp;&nbsp; 
													<select id="myselect"  id="Numero" name="Numero">
													 
													  <option value="1">3126</option>
                                                      <option value="2">3154</option>
                                                      <option value="3">3155</option>          
                                                      </select>
...
<center>
    <table width="85%" border="0" >
  		...
  		<display:table     class="headerDisplay"  name="result"    id="result" cellpadding="0" cellspacing="0" requestURI="" pagesize="2"  >
			...
			<display:column title="N&deg;" ><c:out value="${result.codigo}" /></display:column>
			<display:column title="DESEMBOLSO" ><c:out value="${result.descripcion}" /></display:column>
	
			<display:column title="DOCUMENTO" >		
			<input type="button" class="buttonCls" submit="true" style="width: 140px" value="Ver" name=""  id="" onclick="verTodo('${result.indicador}')"  />
