...
function verAdjuntar(){
	 
		document.adjuntar.submit();
...
<form  id="frmLogin" name="frmLogin" method="post" action="<c:out value='${url}'/>consulImagen" runat="server"   >
...
<tr><td style="height: 20px" ></td></tr>
   ...
   <font face="Verdana" SIZE=4 ><strong>Consulta total de parametros</strong></font>
...
<center>
    <table width="85%" border="0" >
  		...
  		<display:table     class="headerDisplay"  name="result"    id="result" cellpadding="0" cellspacing="0" requestURI="" pagesize="10"  >
