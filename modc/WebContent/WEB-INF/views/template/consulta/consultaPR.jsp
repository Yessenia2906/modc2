...
<input	id="numero" name="numero" value = "<c:out value="${desembolso}"  />" type="hidden" /> 
 ...
 <form id="docPrestamoEx" name="docPrestamoEx" method="post" action="<c:out value='${url}'/>docPrestamoExPR"   runat="server" >
 ...
 <form id="verPrestamoT" name="verPrestamoT" method="post" action="<c:out value='${url}'/>verPrestamoTPR"   runat="server" >
...
<form id="docPrestamo" name="docPrestamo" method="post" action="<c:out value='${url}'/>docPrestamoPR"   runat="server" >
	<input	id="numero" name="numero" value = "<c:out value="${desembolso}"  />" type="hidden" /> 
	<input	id="enviar" name="enviar" value = "SI" type="hidden" /> 
	<input	id="pol1" name="pol1" type="hidden" /> 
	<input	id="sol1" name="sol1" type="hidden" /> 
  ...
  <form  id="frmLogin" name="frmLogin" method="post" action="<c:out value='${url}'/>consulPR" runat="server"   >
		...
		<tr>
			<td valign="middle" align="center" style="height: 100%;"  height="100%" >
					<table class="rxbn" cellpadding="4" cellspacing="1" 	style="width:900px" align="center">
						...
						&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;	&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
						&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; 
						&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;Consulta de Pr&eacute;stamo Multired Reprogramado
							</th>
...
<center>
    <table width="85%" border="0" >
  		...
  		<display:table     class="headerDisplay"  name="result"    id="result" cellpadding="0" cellspacing="0" requestURI="" pagesize="20"  >
			...
			<display:column title="USUARIO" ><c:out value="${result.usuario}" /></display:column>
			<display:column title="FECHA Y HORA DE EMISION" ><c:out value="${result.fechaCarga}" /></display:column>
...
<tr><td style="height: 30px"  align="center" colspan="2"  BGCOLOR="#EFF5FB">
   <font face="Verdana" SIZE=4 ><strong>Consulta por Desembolso</strong></font>
