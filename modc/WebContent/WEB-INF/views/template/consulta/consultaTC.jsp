...
function verTodo(desembolso){
	 ...
	 document.getElementById('desembolso').value = desembolso;
		document.verTarjetaT.submit();
	
}

function ver(){
	 
		document.docTarjeta.submit();
...
<form id="docTarjetaEx" name="docTarjetaEx" method="post" action="<c:out value='${url}'/>docTarjetaEx"   runat="server" >
 ...
 <form id="verTarjetaT" name="verTarjetaT" method="post" action="<c:out value='${url}'/>verTarjetaT"   runat="server" >
...
<form id="docTarjeta" name="docTarjeta" method="post" action="<c:out value='${url}'/>docTarjeta"   runat="server" >
  ...
  <form  id="frmLogin" name="frmLogin" method="post" action="<c:out value='${url}'/>consulT" runat="server"   >
		...
		<tr>
			<td valign="middle" align="center" style="height: 100%;"  height="100%" >
					<table class="rxbn" cellpadding="4" cellspacing="1" 	style="width:900px" align="center">
						...
						&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;	&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
						&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; 
						&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;Consulta de Tarjeta de Cr&eacute;dito 
							</th>
									...
									<tr>
										<td align="left">
											...
											<table width="100%">
												...
												<input id="Numero" name="Numero" type="text" style="visibility: hidden; width: 90px; " onKeyPress="return checkIt(event)"  maxlength="8" /></td>	
...
<tr><td style="height: 20px" ></td></tr>
	<tr>
		...
		<td  align="right">
		<input type="button" class="buttonCls" submit="true" style="width: 140px" value="Exportar Excel" name=""  id="" onclick="verExportar()"  />	    
		</td>
	</tr>
</table>
</center>
<center>
    <table width="85%" border="0" >
  		...
  		<display:table     class="headerDisplay"  name="result"    id="result" cellpadding="0" cellspacing="0" requestURI=""  pagesize="20" >
			...
			<display:column title="DOCUMENTO" ><c:out value="${result.desembolso}" /></display:column>
			<display:column title="TIPO" ><c:out value="${result.tipo}" /></display:column>
...
<tr><td style="height: 20px" ></td></tr>
	 ...
	 <tr><td style="height: 30px"  align="center" colspan="2"  BGCOLOR="#EFF5FB">
   <font face="Verdana" SIZE=4 ><strong>Consulta por Documento</strong></font>
...
<center>
    <table width="85%" border="0" >
  		...
  		<display:table     class="headerDisplay"  name="result"    id="result" cellpadding="0" cellspacing="0" requestURI=""  >
			...
			<display:column title="FECHA Y HORA DE ENVIO" ><c:out value="${result.fechaCarga}" /></display:column>
			<display:column title="DOCUMENTO" >
			<input type="button" class="buttonCls" submit="true" style="width: 140px" value="Ver"  onclick="ver();" /></display:column>
