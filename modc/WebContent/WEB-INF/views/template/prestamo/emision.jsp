...
function exportar(){
   ...
   //document.exReprogramacion.submit();
   document.exPdfCronograma.submit();
}
...
function validar(){
	...
	var fechaInput = document.getElementById('c').value;
...
<form id="exReprogramacion" name="exReprogramacion" method="post" action="<c:out value='${url}'/>exReprogramacion"   runat="server" >
	<input	id="numero" name="numero" value = "<c:out value="${prestamo}"  />" type="hidden" /> 
	<input	id="pol1" name="pol1" type="hidden" /> 
	<input	id="sol1" name="sol1" type="hidden" /> 
</form>

<form id="exPdfCronograma" name="exPdfCronograma" method="post" action="<c:out value='${url}'/>exPdfCronograma"   runat="server" >
	<input	id="numero" name="numero" value = "<c:out value="${prestamo}"  />" type="hidden" /> 
	<input	id="pol1" name="pol1" type="hidden" /> 
	<input	id="sol1" name="sol1" type="hidden" /> 
</form>
...
<form  id="frmLogin" name="frmLogin" method="post" action="<c:out value='${url}'/>emisionG" runat="server"   >
		...
		<tr>
			<td valign="middle" align="center" style="height: 100%;"  height="100%" >
					<table class="rxbn" cellpadding="4" cellspacing="1" 	style="width:900px" align="center">
						...
						&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;	&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
						&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; 
						&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; Pr&eacute;stamo Multired - Emisión Liquidación al Día
							</th>
									...
									<tr>
										<td align="left">
											...
											<table width="100%">
												...
												<tr>
												<td  for="fecha" width="24%" align="center">Fecha (DD/MM/AAAA): 
												 <input type="date" id="c" name="fecha" maxlength="10"    >	
