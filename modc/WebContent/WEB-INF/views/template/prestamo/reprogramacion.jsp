...
<form  id="frmLogin" name="frmLogin" method="post" action="<c:out value='${url}'/>reprogramacionG" runat="server"   >
		...
		<tr>
			<td valign="middle" align="center" style="height: 100%;"  height="100%" >
					<table class="rxbn" cellpadding="4" cellspacing="1" 	style="width:900px" align="center">
						...
						&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;	&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
						&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; 
						&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; Pr&eacute;stamo Multired - Cronograma Reprogramado
							</th>
...
<table width="60%" align="center" bgcolor="white">
	<tr>
		...
		<input type="button" onclick="exportar()"    class= "small"	value="Generar Cronograma">
