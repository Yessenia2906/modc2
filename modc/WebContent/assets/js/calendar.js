...
(function() {
    ...
    DayPilotCalendar.Calendar = function(id) {
        ...
        this.drawEvent = function(data) {
            ...
            var borderColor = data.colorBorder;
            ...
            inside.push("px;background-color:"); //aqui2
            inside.push(data.colorBack);
        ...
        this.getScrollableHeight = function() {
            switch (this.heightSpec) {
                ...
                case "BusinessHours":
                    ...
                    return dHours * this.cellHeight * this.amplitud;  //cambio
                default:
            ...
            for(var i = 0; i < this.columns.length; i++) {
                ...
                for (var j = 0; j < length; j++) {
                    ...
                    if (belongsHere) {
                        ...
                        ep.Text = e.Text;
                        ep.Value = e.Value;
                        ep.ToolTip = e.ToolTip;
                        ep.colorBack  = e.colorBack;
                        ep.colorBorder  = e.colorBorder;
                        ep.mensajeTool = e.mensajeTool;
                        ep.Start = start;
                        ep.End = end;
                        ep.DayIndex = i;
