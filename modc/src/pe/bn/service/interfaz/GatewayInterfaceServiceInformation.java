...
public class GatewayInterfaceServiceInformation implements com.ibm.ws.webservices.multiprotocol.ServiceInformation {
    ...
    private static com.ibm.ws.webservices.engine.description.OperationDesc _enviarTramaConsulta0Op() {
        ...
        _params0[0].setOption("partQNameString","{http://bean.service.bn.pe}RequestGateway");
        _params0[0].setOption("inputPosition","0");
        _params0[0].setOption("partName","RequestGateway");
        ...
        enviarTramaConsulta0Op.setOption("inoutOrderingReq","false");
        enviarTramaConsulta0Op.setOption("buildNum","f5011932.01");
