...
public class BodySolicitud2 extends WSData{
	
	private static LoggerMODC log3 = LoggerMODC
	.getInstance(BodySolicitud2.class.getName());

	
	public void init(){
		
		this.campos = new Campo[171];
		try {
			...
			this.campos[++num]		=	new Campo("W-MAIL-ADI-01",  Campo.CHARACTER, 30);
			this.campos[++num]		=	new Campo("W-NOTIFICA-ADI-01",  Campo.CHARACTER, 1);
			this.campos[++num]		=	new Campo("W-OEXTERIO-ADI-01",  Campo.CHARACTER, 1);
			this.campos[++num]		=	new Campo("W-MVIRTUAL-ADI-01",  Campo.CHARACTER, 1);
			this.campos[++num]		=	new Campo("W-TLF-CEL-ADI-01",  Campo.CHARACTER, 10);
			...
			this.campos[++num]		=	new Campo("W-MAIL-ADI-02",  Campo.CHARACTER, 30);
			this.campos[++num]		=	new Campo("W-NOTIFICA-ADI-02",  Campo.CHARACTER, 1);
			this.campos[++num]		=	new Campo("W-OEXTERIO-ADI-02",  Campo.CHARACTER, 1);
			this.campos[++num]		=	new Campo("W-MVIRTUAL-ADI-02",  Campo.CHARACTER, 1);
			this.campos[++num]		=	new Campo("W-TLF-CEL-ADI-02",  Campo.CHARACTER, 10);
			...
			this.campos[++num]		=	new Campo("W-MAIL-ADI-03",  Campo.CHARACTER, 30);
			this.campos[++num]		=	new Campo("W-NOTIFICA-ADI-03",  Campo.CHARACTER, 1);
			this.campos[++num]		=	new Campo("W-OEXTERIO-ADI-03",  Campo.CHARACTER, 1);
			this.campos[++num]		=	new Campo("W-MVIRTUAL-ADI-03",  Campo.CHARACTER, 1);
			this.campos[++num]		=	new Campo("W-TLF-CEL-ADI-03",  Campo.CHARACTER, 10);
			...
			this.campos[++num]		=	new Campo("W-MAIL-ADI-04",  Campo.CHARACTER, 30);
			this.campos[++num]		=	new Campo("W-NOTIFICA-ADI-04",  Campo.CHARACTER, 1);
			this.campos[++num]		=	new Campo("W-OEXTERIO-ADI-04",  Campo.CHARACTER, 1);
			this.campos[++num]		=	new Campo("W-MVIRTUAL-ADI-04",  Campo.CHARACTER, 1);
			this.campos[++num]		=	new Campo("W-TLF-CEL-ADI-04",  Campo.CHARACTER, 10);
