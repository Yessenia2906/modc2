...
public class BodyCancelacion extends WSData{
	
	private static LoggerMODC log3 = LoggerMODC.getInstance(BodyCancelacion.class.getName());
...
public void cargarData (String dni) throws Exception {
