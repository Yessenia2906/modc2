...
public class BnSolicitud {
	...
	private String MAIL_ADI_01;
	private String NOTIFICA_ADI_01;
	private String OEXTERIO_ADI_01;
	private String MVIRTUAL_ADI_01;
	private String TLF_CEL_ADI_01;
	...
	private String MAIL_ADI_02;
	private String NOTIFICA_ADI_02;
	private String OEXTERIO_ADI_02;
	private String MVIRTUAL_ADI_02;
	private String TLF_CEL_ADI_02;
	...
	private String MAIL_ADI_03;
	private String NOTIFICA_ADI_03;
	private String OEXTERIO_ADI_03;
	private String MVIRTUAL_ADI_03;
	private String TLF_CEL_ADI_03;
	...
	private String MAIL_ADI_04;
	private String NOTIFICA_ADI_04;
	private String OEXTERIO_ADI_04;
	private String MVIRTUAL_ADI_04;
	private String TLF_CEL_ADI_04;
	...
	public String getMAIL_ADI_01() {
		return MAIL_ADI_01;
	}
	public void setMAIL_ADI_01(String mAIL_ADI_01) {
		MAIL_ADI_01 = mAIL_ADI_01;
	}
	public String getNOTIFICA_ADI_01() {
		return NOTIFICA_ADI_01;
	}
	public void setNOTIFICA_ADI_01(String nOTIFICA_ADI_01) {
		NOTIFICA_ADI_01 = nOTIFICA_ADI_01;
	}
	public String getOEXTERIO_ADI_01() {
		return OEXTERIO_ADI_01;
	}
	public void setOEXTERIO_ADI_01(String oEXTERIO_ADI_01) {
		OEXTERIO_ADI_01 = oEXTERIO_ADI_01;
	}
	public String getMVIRTUAL_ADI_01() {
		return MVIRTUAL_ADI_01;
	}
	public void setMVIRTUAL_ADI_01(String mVIRTUAL_ADI_01) {
		MVIRTUAL_ADI_01 = mVIRTUAL_ADI_01;
	}
	public String getTLF_CEL_ADI_01() {
		return TLF_CEL_ADI_01;
	}
	public void setTLF_CEL_ADI_01(String tLF_CEL_ADI_01) {
		TLF_CEL_ADI_01 = tLF_CEL_ADI_01;
	}
	public String getMAIL_ADI_02() {
		return MAIL_ADI_02;
	}
	public void setMAIL_ADI_02(String mAIL_ADI_02) {
		MAIL_ADI_02 = mAIL_ADI_02;
	}
	public String getNOTIFICA_ADI_02() {
		return NOTIFICA_ADI_02;
	}
	public void setNOTIFICA_ADI_02(String nOTIFICA_ADI_02) {
		NOTIFICA_ADI_02 = nOTIFICA_ADI_02;
	}
	public String getOEXTERIO_ADI_02() {
		return OEXTERIO_ADI_02;
	}
	public void setOEXTERIO_ADI_02(String oEXTERIO_ADI_02) {
		OEXTERIO_ADI_02 = oEXTERIO_ADI_02;
	}
	public String getMVIRTUAL_ADI_02() {
		return MVIRTUAL_ADI_02;
	}
	public void setMVIRTUAL_ADI_02(String mVIRTUAL_ADI_02) {
		MVIRTUAL_ADI_02 = mVIRTUAL_ADI_02;
	}
	public String getTLF_CEL_ADI_02() {
		return TLF_CEL_ADI_02;
	}
	public void setTLF_CEL_ADI_02(String tLF_CEL_ADI_02) {
		TLF_CEL_ADI_02 = tLF_CEL_ADI_02;
	}
	public String getMAIL_ADI_03() {
		return MAIL_ADI_03;
	}
	public void setMAIL_ADI_03(String mAIL_ADI_03) {
		MAIL_ADI_03 = mAIL_ADI_03;
	}
	public String getNOTIFICA_ADI_03() {
		return NOTIFICA_ADI_03;
	}
	public void setNOTIFICA_ADI_03(String nOTIFICA_ADI_03) {
		NOTIFICA_ADI_03 = nOTIFICA_ADI_03;
	}
	public String getOEXTERIO_ADI_03() {
		return OEXTERIO_ADI_03;
	}
	public void setOEXTERIO_ADI_03(String oEXTERIO_ADI_03) {
		OEXTERIO_ADI_03 = oEXTERIO_ADI_03;
	}
	public String getMVIRTUAL_ADI_03() {
		return MVIRTUAL_ADI_03;
	}
	public void setMVIRTUAL_ADI_03(String mVIRTUAL_ADI_03) {
		MVIRTUAL_ADI_03 = mVIRTUAL_ADI_03;
	}
	public String getTLF_CEL_ADI_03() {
		return TLF_CEL_ADI_03;
	}
	public void setTLF_CEL_ADI_03(String tLF_CEL_ADI_03) {
		TLF_CEL_ADI_03 = tLF_CEL_ADI_03;
	}
	public String getMAIL_ADI_04() {
		return MAIL_ADI_04;
	}
	public void setMAIL_ADI_04(String mAIL_ADI_04) {
		MAIL_ADI_04 = mAIL_ADI_04;
	}
	public String getNOTIFICA_ADI_04() {
		return NOTIFICA_ADI_04;
	}
	public void setNOTIFICA_ADI_04(String nOTIFICA_ADI_04) {
		NOTIFICA_ADI_04 = nOTIFICA_ADI_04;
	}
	public String getOEXTERIO_ADI_04() {
		return OEXTERIO_ADI_04;
	}
	public void setOEXTERIO_ADI_04(String oEXTERIO_ADI_04) {
		OEXTERIO_ADI_04 = oEXTERIO_ADI_04;
	}
	public String getMVIRTUAL_ADI_04() {
		return MVIRTUAL_ADI_04;
	}
	public void setMVIRTUAL_ADI_04(String mVIRTUAL_ADI_04) {
		MVIRTUAL_ADI_04 = mVIRTUAL_ADI_04;
	}
	public String getTLF_CEL_ADI_04() {
		return TLF_CEL_ADI_04;
	}
	public void setTLF_CEL_ADI_04(String tLF_CEL_ADI_04) {
		TLF_CEL_ADI_04 = tLF_CEL_ADI_04;
	}
	...
	public String toString() {
		return "BnSolicitud [TIPDOC=" + TIPDOC + ", NUMDOC=" + NUMDOC
				+ ", APELLTIT=" + APELLTIT + ", NOMBRTIT=" + NOMBRTIT
				+ ", ESTCV=" + ESTCV + ", SEXO=" + SEXO + ", TIPVIV=" + TIPVIV
				+ ", DEPENDI=" + DEPENDI + ", MAIL=" + MAIL + ", CODVIA="
				+ CODVIA + ", NOMVIA=" + NOMVIA + ", NUMVIA=" + NUMVIA
				+ ", CODZON=" + CODZON + ", NOMZON=" + NOMZON + ", UBGCLI="
				+ UBGCLI + ", REFEREN=" + REFEREN + ", TLFCASA=" + TLFCASA
				+ ", TLFCELL=" + TLFCELL + ", EMPLAB_TIT=" + EMPLAB_TIT
				+ ", FCHING=" + FCHING + ", CODVIA_LAB=" + CODVIA_LAB
				+ ", NOMVIA_LAB=" + NOMVIA_LAB + ", NUMVIA_LAB=" + NUMVIA_LAB
				+ ", CODZON_LAB=" + CODZON_LAB + ", NOMZON_LAB=" + NOMZON_LAB
				+ ", UBGDOM_LAB=" + UBGDOM_LAB + ", REFEREN_LAB=" + REFEREN_LAB
				+ ", TLFLAB=" + TLFLAB + ", ANXLAB=" + ANXLAB + ", REFERENPER="
				+ REFERENPER + ", TLFREF=" + TLFREF + ", NOMBRE_CYG="
				+ NOMBRE_CYG + ", EMPLAB_CYG=" + EMPLAB_CYG + ", TLFTRA_CYG="
				+ TLFTRA_CYG + ", ANXTRA_CYG=" + ANXTRA_CYG + ", LINCRE_GLB="
				+ LINCRE_GLB + ", CCLO_FAC=" + CCLO_FAC + ", TIPCTA_CAR="
				+ TIPCTA_CAR + ", MON_CAR=" + MON_CAR + ", CTA_CAR=" + CTA_CAR
				+ ", NOMCOR_CLI=" + NOMCOR_CLI + ", LINCRE_CTA=" + LINCRE_CTA
				+ ", CCLOFAC_CTA=" + CCLOFAC_CTA + ", FCH_NAC=" + FCH_NAC
				+ ", SLD_CLI=" + SLD_CLI + ", BLQ_CAR=" + BLQ_CAR
				+ ", BLQ_CTA=" + BLQ_CTA + ", PLAN_CAS=" + PLAN_CAS
				+ ", PLAN_RET=" + PLAN_RET + ", COD_AGE=" + COD_AGE
				+ ", CODCTR_EVA=" + CODCTR_EVA + ", CODPROMOTOR=" + CODPROMOTOR
				+ ", CODFUNCION=" + CODFUNCION + ", NOM_EN_PLAST="
				+ NOM_EN_PLAST + ", NOM_EMP_PLAST=" + NOM_EMP_PLAST
				+ ", TIPDIR_ENT=" + TIPDIR_ENT + ", CODVIA_ENT=" + CODVIA_ENT
				+ ", NOMVIA_ENT=" + NOMVIA_ENT + ", NUMVIA_ENT=" + NUMVIA_ENT
				+ ", CODZON_ENT=" + CODZON_ENT + ", NOMZON_ENT=" + NOMZON_ENT
				+ ", UBGDOM_ENT=" + UBGDOM_ENT + ", REFEREN_ENT=" + REFEREN_ENT
				+ ", MANDATR_01=" + MANDATR_01 + ", MANDATR_02=" + MANDATR_02
				+ ", UBG_CLI_DEP=" + UBG_CLI_DEP + ", UBG_CLI_PRO="
				+ UBG_CLI_PRO + ", UBG_CLI_DIS=" + UBG_CLI_DIS
				+ ", UBG_DOM_LAB_DEP=" + UBG_DOM_LAB_DEP + ", UBG_DOM_LAB_PRO="
				+ UBG_DOM_LAB_PRO + ", UBG_DOM_LAB_DIS=" + UBG_DOM_LAB_DIS
				+ ", UBG_ZON_ENT_DEP=" + UBG_ZON_ENT_DEP + ", UBG_ZON_ENT_PRO="
				+ UBG_ZON_ENT_PRO + ", UBG_ZON_ENT_DIS=" + UBG_ZON_ENT_DIS
				+ ", LCORRES=" + LCORRES + ", DISPOS=" + DISPOS + ", ENDOSO="
				+ ENDOSO + ", NOTIFICA=" + NOTIFICA + ", OEXTERIO=" + OEXTERIO
				+ ", MVIRTUAL=" + MVIRTUAL + ", NPOLIZA=" + NPOLIZA
				+ ", TIPTARJETA=" + TIPTARJETA + ", CONDLABORA=" + CONDLABORA
				+ ", CTAAHORRO=" + CTAAHORRO + ", NROTARJETA=" + NROTARJETA
				+ ", CELL_SMS=" + CELL_SMS + ", FCH_SOLICITA=" + FCH_SOLICITA
				+ ", NOM_TECNICO=" + NOM_TECNICO + ", NOM_FUNCIONARIO="
				+ NOM_FUNCIONARIO + ", NOM_AGENCIA=" + NOM_AGENCIA
				+ ", COD_AGENCIA=" + COD_AGENCIA + ", NOB_VIA_TIT="
				+ NOB_VIA_TIT + ", NOB_VIA_LAB=" + NOB_VIA_LAB + ", SECTOR="
				+ SECTOR + ", SDESGRAVA=" + SDESGRAVA + ", DDEPEND=" + DDEPEND
				+ ", NTELEF_DEPEND=" + NTELEF_DEPEND + ", NROTARJDEB="
				+ NROTARJDEB + ", CORRELATIVO=" + CORRELATIVO + ", ANEXOLABOR="
				+ ANEXOLABOR + ", IND_ARRAY=" + IND_ARRAY + ", TIPOCARDADI_01="
				+ TIPOCARDADI_01 + ", NUMECARDADI_01=" + NUMECARDADI_01
				+ ", LINECARDADI_01=" + LINECARDADI_01 + ", TIPDOC_ADI_01="
				+ TIPDOC_ADI_01 + ", NUMDOC_ADI_01=" + NUMDOC_ADI_01
				+ ", APELL_ADI_01=" + APELL_ADI_01 + ", NOMBR_ADI_01="
				+ NOMBR_ADI_01 + ", FCHNAC_ADI_01=" + FCHNAC_ADI_01
				+ ", SEXO_ADI_01=" + SEXO_ADI_01 + ", DISPOS_ADI_01="
				+ DISPOS_ADI_01 + ", FECHAOPER_ADI_01=" + FECHAOPER_ADI_01
				+ ", MAIL_ADI_01=" + MAIL_ADI_01 + ", NOTIFICA_ADI_01="
				+ NOTIFICA_ADI_01 + ", OEXTERIO_ADI_01=" + OEXTERIO_ADI_01
				+ ", MVIRTUAL_ADI_01=" + MVIRTUAL_ADI_01 + ", TLF_CEL_ADI_01="
				+ TLF_CEL_ADI_01 + ", TIPOCARDADI_02=" + TIPOCARDADI_02
				+ ", NUMECARDADI_02=" + NUMECARDADI_02 + ", LINECARDADI_02="
				+ LINECARDADI_02 + ", TIPDOC_ADI_02=" + TIPDOC_ADI_02
				+ ", NUMDOC_ADI_02=" + NUMDOC_ADI_02 + ", APELL_ADI_02="
				+ APELL_ADI_02 + ", NOMBR_ADI_02=" + NOMBR_ADI_02
				+ ", FCHNAC_ADI_02=" + FCHNAC_ADI_02 + ", SEXO_ADI_02="
				+ SEXO_ADI_02 + ", DISPOS_ADI_02=" + DISPOS_ADI_02
				+ ", FECHAOPER_ADI_02=" + FECHAOPER_ADI_02 + ", MAIL_ADI_02="
				+ MAIL_ADI_02 + ", NOTIFICA_ADI_02=" + NOTIFICA_ADI_02
				+ ", OEXTERIO_ADI_02=" + OEXTERIO_ADI_02 + ", MVIRTUAL_ADI_02="
				+ MVIRTUAL_ADI_02 + ", TLF_CEL_ADI_02=" + TLF_CEL_ADI_02
				+ ", TIPOCARDADI_03=" + TIPOCARDADI_03 + ", NUMECARDADI_03="
				+ NUMECARDADI_03 + ", LINECARDADI_03=" + LINECARDADI_03
				+ ", TIPDOC_ADI_03=" + TIPDOC_ADI_03 + ", NUMDOC_ADI_03="
				+ NUMDOC_ADI_03 + ", APELL_ADI_03=" + APELL_ADI_03
				+ ", NOMBR_ADI_03=" + NOMBR_ADI_03 + ", FCHNAC_ADI_03="
				+ FCHNAC_ADI_03 + ", SEXO_ADI_03=" + SEXO_ADI_03
				+ ", DISPOS_ADI_03=" + DISPOS_ADI_03 + ", FECHAOPER_ADI_03="
				+ FECHAOPER_ADI_03 + ", MAIL_ADI_03=" + MAIL_ADI_03
				+ ", NOTIFICA_ADI_03=" + NOTIFICA_ADI_03 + ", OEXTERIO_ADI_03="
				+ OEXTERIO_ADI_03 + ", MVIRTUAL_ADI_03=" + MVIRTUAL_ADI_03
				+ ", TLF_CEL_ADI_03=" + TLF_CEL_ADI_03 + ", TIPOCARDADI_04="
				+ TIPOCARDADI_04 + ", NUMECARDADI_04=" + NUMECARDADI_04
				+ ", LINECARDADI_04=" + LINECARDADI_04 + ", TIPDOC_ADI_04="
				+ TIPDOC_ADI_04 + ", NUMDOC_ADI_04=" + NUMDOC_ADI_04
				+ ", APELL_ADI_04=" + APELL_ADI_04 + ", NOMBR_ADI_04="
				+ NOMBR_ADI_04 + ", FCHNAC_ADI_04=" + FCHNAC_ADI_04
				+ ", SEXO_ADI_04=" + SEXO_ADI_04 + ", DISPOS_ADI_04="
				+ DISPOS_ADI_04 + ", FECHAOPER_ADI_04=" + FECHAOPER_ADI_04
				+ ", MAIL_ADI_04=" + MAIL_ADI_04 + ", NOTIFICA_ADI_04="
				+ NOTIFICA_ADI_04 + ", OEXTERIO_ADI_04=" + OEXTERIO_ADI_04
				+ ", MVIRTUAL_ADI_04=" + MVIRTUAL_ADI_04 + ", TLF_CEL_ADI_04="
				+ TLF_CEL_ADI_04 + ", PERSONA_AUTOR=" + PERSONA_AUTOR
				+ ", TDOCUM_AUTOR=" + TDOCUM_AUTOR + ", NDOCUM_AUTOR="
				+ NDOCUM_AUTOR + ", NOMBRE_GRABAR=" + NOMBRE_GRABAR
				+ ", CODRESP=" + CODRESP + ", MSGRESP=" + MSGRESP + "]";
	}
