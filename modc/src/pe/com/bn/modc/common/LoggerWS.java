...
public class LoggerWS {
	...
	private String FQCN = "";
	private static LoggerWS log3 = LoggerWS.getInstance(LoggerWS.class.getName());

	protected LoggerWS(String name) {
		FQCN = name;
	}

	  public static LoggerWS getInstance(String name) {
		
		LoggerWS hub = new LoggerWS(name); 
	    return hub; 
	  }
	  ...
	  /*
		...
		*/
		...
		public void error(String e,String codigoError,String mensaje) {
			if(!isPrintLogErr("ERROR")) return;
			...
			try {
				...
				String tracer="";
				if(e!=null){
					formato = formato  + "STRING:" + e.toString() + "|MESSAGE:" + mensaje + "|CODIGO:" + codigoError; 
					formato = formato  + "|TRACE:\n" + tracer ;
				}
